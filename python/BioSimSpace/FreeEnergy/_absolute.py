...
"""
Functionality for absolute free-energy simulations.
"""

__author__ = "William (Zhiyi) Wu"
__email__ = "zwu@exscientia.co.uk"
    ...
    def __init__(self, system, protocol=None, work_dir=None, engine=None,
        ...
        """Constructor.
           ...
           engine: str
               ...
               options are "GROMACS" only. If this argument is omitted then
        ...
        if engine is not None:
            ...
            if engine == "GROMACS":
                ...
                # TODO: Ensure that the molecule to be decoupled will be marked
